...
let imgseptimou2= ["1.png", "2.png", "3.png", "4.png", "5.png"];

//arreglo que guardara la opcion correcta
let correcta = [2,2,1,1,0];

//arreglo que guardara los paises a mostrar en cada jugada
let opciones = [];septimou2
...
function cargarseptimou2(){
    ...
    if(banderas.length <= posActual){
        ...
        document.getElementById("septimou2").src = "img/" + banderas[posActual];
...
function comprobarRespuesta(opElegida){
    ...
    setTimeout(cargarseptimou2,1000);
}
